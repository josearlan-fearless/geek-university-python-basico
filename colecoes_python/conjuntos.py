...
lista = [99, 2, 2, 34, 23, 12, 1, 44, 5, 34]
...
# informam normalmente a cidade de onde vieram.
...
s.add(4)
s.add(4)  # Duplicidade não gera error, simplesmente é ignorado e não é adicionado.
print(s)
===========================================================================
===========================================================================
...
# Imagine que temos dois conjuntos: Um contendo estudantes do cruso de Python e um
# contendo estudantes do curso de Java.

estudantes_python = {'Marcos', 'Patrícia', 'Ellne', 'Pedro', 'Júlia', 'Guilherme'}
estudantes_java = {'Fernando', 'Gustavo', 'Júlia', 'Anna', 'Patrícia'}
...
# {'Júlia', 'Guilherme', 'Gustavo', 'Pedro', 'Marcos', 'Anna', 'Patrícia', 'Ellne', 'Fernando'}
# unicos1 = estudantes_python.union(estudantes_java)
# {'Gustavo', 'Patrícia', 'Júlia', 'Fernando', 'Marcos', 'Ellne', 'Pedro', 'Guilherme', 'Anna'}
print(unicos1)
