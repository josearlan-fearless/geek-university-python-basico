"""
Reduce
OBS: A partir do Python 3+ a função reduce() não é mais uma função integrada (built-in). Agora
...
Ou seja, em cada passo ela aplica a função passando como primeiro argumento o restuldado da aplicação anterior.
