...
OBS: Não confunda, apesar do nome, com a função sort() qeu já estudamos em Listas. O sort()
...
print(tuple(sorted(numeros)))  # Convertendo para outro tipo, ex: tupla, set etc...
...
# Ordenando por tweets - Quantidade de tweets realizados
