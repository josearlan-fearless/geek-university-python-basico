...
# Por debaixo dos planos quando utilizamos a função len() o Python faz o seguinte:
...
abs() -> Retorna o valor absoluto de um número inteiro ou real. De forma básica, seria o seu
...
round() -> Retorna um número arredondado para n digito de precisão após a casa decimal. Se
...
print(round(1.2121212121, 2))  # Real
print(round(1.2199999999, 2))  # Real
