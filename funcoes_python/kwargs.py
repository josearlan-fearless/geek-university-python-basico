...
Poderíamos chamar este parâmetro de **xis, mas por convênção chamamos de **kwargs

Este [e só mais um parâmetro, mas diferente do *args que coloca os valores extras
em uma tupla, o **kwargs exige qeu utilizemos parâmetros nomeados, e transforma esses
