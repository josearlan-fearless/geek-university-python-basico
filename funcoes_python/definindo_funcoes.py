...
- Funções são pequenos partes de código qeu realizam tarefas específicas:
- Pode ou não receber entradas de dados e retornar uma saída de dados;
- Muito úteis para executar procedimentos similares por repetidas vezes;

OBS: Se você escrever uma função que realiza várias tarefas detro dela;
...
da função acontece. Neste bloco, pode ter ou não retorno da função.
...
2 - Veja que nossa função só executa 1 tarefa, ou seja, a única coisa ue ela faz é dizer oi;
